...
srun --mpi=cray_shasta --cpu_bind=cores --job-name='inclusi2j W+' ./mcfm CollinearW.ini -general%part=nnlocoeff -general%rundir=collinearW_nnlocoeff -general%nproc=11 -general%runstring=Wp_inclusi2j
srun --mpi=cray_shasta --cpu_bind=cores --job-name='inclusi2j W-' ./mcfm CollinearW.ini -general%part=nnlocoeff -general%rundir=collinearW_nnlocoeff -general%nproc=16 -general%runstring=Wm_inclusi2j
